...
1. In your preferred browser, open welcome-page.html file in procrasti-NOT folder. 
2. Test A using an account already created and test B using an account that you created.
3. Note that if the login may need to be entered twice due to a bug. 
